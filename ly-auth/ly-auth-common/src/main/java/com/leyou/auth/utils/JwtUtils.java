...
public class JwtUtils {
  ...
  /*  public static void main(String[] args) throws Exception {
        //密钥存放路径
        String publicKeyFilename = "K:\\JetBrains\\rsa\\rsa.pub";
        String privateKeyFilename = "K:\\JetBrains\\rsa\\rsa.pri";
        //读取公钥和私钥
        ...
        //生成token
        String token = generateTokenInMinutes(new UserInfo(2L, "leyou"), privateKey, 3);
